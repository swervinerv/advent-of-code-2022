...
internal class Solution : SolutionBase
{
    ...
    protected override string SolvePartTwo()
    {
        ...
        var totalSize = baseFile.GetSize();
        var currentUnused = 70000000 - totalSize;
        var minDirectorySizeToDelete = 30000000 - currentUnused;

        var directoryToDelete = directoryHash
            .Where(_ => _.Value.GetSize() >= minDirectorySizeToDelete)
            .OrderBy(_ => _.Value.GetSize())
            .FirstOrDefault();

        return directoryToDelete.Value.GetSize().ToString();
    }
